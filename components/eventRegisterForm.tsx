...
export default function EventRegisterForm({ formData, handleInputChange, handleSubmit, loading, formType }: Readonly<{ formData: any, handleInputChange: any, handleSubmit: any, loading: boolean, formType: string }>) {
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className="bg-card rounded-xl border border-border p-8">
            ...
            {/* Message */}
            <div className="mb-8">
              <label htmlFor="additionalMessage" className="block text-sm font-semibold text-foreground mb-2">What do you hope to gain from this event?</label>
            ...
            >
              {loading ? 'Submitting...' : 'Submit Event Registration'}
            </button>
        </form>
    )
}